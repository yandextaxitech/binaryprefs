...
public final class IntegerSerializationStrategyImpl implements SerializationStrategy {

    private final int value;
    private final IntegerSerializer integerSerializer;

    public IntegerSerializationStrategyImpl(int value, SerializerFactory serializerFactory) {
        this.value = value;
